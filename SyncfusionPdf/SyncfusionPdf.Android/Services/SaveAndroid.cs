...
using SyncfusionPdf.Droid.Services;
using SyncfusionPdf.Services;

[assembly: Dependency(typeof(SaveAndroid))]
namespace SyncfusionPdf.Droid.Services
{
    class SaveAndroid : ISave
    {
        ...
        public async Task SaveAndView(string fileName, String contentType, MemoryStream stream)
        {
            try
            {
                ...
                root = System.IO.Path.Combine(Android.OS.Environment.GetExternalStoragePublicDirectory(Android.OS.Environment.DirectoryDownloads).ToString());
